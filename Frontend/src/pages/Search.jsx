...
function Search() {
    ...
    return (
        <div className='flex flex-col md:flex-row'>
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            <option className='created_at_desc'>Latest</option>
                            <option className='created_at_asc'>Oldest</option>
                        </select>
                    </div>
                    <button
            ...
            <div>
                <h1
                    className='text-3xl font-semibold border-b border-gray-200 p-3 text-slate-700 mt-5'
                >Listing Results:</h1>
